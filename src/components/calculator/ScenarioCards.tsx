        ...
        <CardContent className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium tracking-tight">{config.label}</span>
            </div>
          ...
          <div className="flex items-end justify-between gap-3">
            <div className="space-y-0.5">
              <div className="text-[11px] uppercase tracking-wider text-muted-foreground">Projected portfolio</div>
              <div className="text-2xl font-semibold tabular-nums tracking-tight">
                {formatCurrency(readiness.projectedAtRetirement, true)}
              </div>
            </div>
            <Tooltip>
              ...
              <TooltipContent className="text-xs max-w-[220px]">
                Coverage = projected portfolio ÷ required portfolio. 100% means you&apos;re fully funded for your target income; below 100% you&apos;ll fall short.
              </TooltipContent>
            </Tooltip>
          </div>
          ...
          {/* Expandable details */}
          {showDetails && (
            <div className="space-y-1 pt-3 border-t text-xs animate-in fade-in slide-in-from-top-1 duration-150">
  ...
  return (
    <section className="space-y-3">
      <div className="flex items-baseline justify-between">
        <h2 className="text-[11px] font-semibold text-muted-foreground uppercase tracking-[0.12em]">Scenarios</h2>
        <span className="text-[11px] text-muted-foreground/70">Tap a card for detail</span>
      </div>
